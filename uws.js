...
module.exports = (() => {
	try {
		...
		throw new Error('This version of uWS.js (v1.0.3) supports only Node.js versions 20, 22, 23 and 24 on (glibc) Linux, on Tier 1 platforms (https://github.com/nodejs/node/blob/master/BUILDING.md#platform-list).\n\n' + e.toString());
	}
})();
